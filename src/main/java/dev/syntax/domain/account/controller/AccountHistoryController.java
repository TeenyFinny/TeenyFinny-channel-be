...
public class AccountHistoryController {
     ...
     * 부모는 {@link #getChildHistory(UserContext, Long, AccountHistoryReq)} API를 사용해야 합니다.
     * </p>
     *
     ...
     *
     * @throws dev.syntax.global.exception.BusinessException 권한 없을 때 (TX_NO_PERMISSION)
     * @see AccountHistoryService#getHistory(Long, AccountHistoryReq, UserContext)
     */
     ...
     *         <ul>
     *           <li>TX_INVALID_TRANSACTION_ID – 잘못된 거래 ID</li>
     *           <li>TX_NOT_FOUND – 거래가 존재하지 않을 경우</li>
     *           <li>TX_ACCOUNT_NOT_FOUND – 거래가 속한 계좌 없음</li>
     *           <li>TX_NO_PERMISSION – 접근 권한 없음</li>
     *         </ul>
     *
