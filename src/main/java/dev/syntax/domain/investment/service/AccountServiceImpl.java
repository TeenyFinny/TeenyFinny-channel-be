...
public class AccountServiceImpl implements AccountService {
    ...
    CoreInvestmentClient coreInvestmentClient;
    ...
    @Override
    public InvestAccountRes getInvestAccount(String cano, UserContext userContext) {
        return coreInvestmentClient.getInvestAccount(cano, userContext);
    }
}
